...
internal class BluetoothHeadsetManager
    ...
    internal constructor(
        ...
        fun hasActivationError(): Boolean = headsetState == AudioActivationError
        ...
        private fun isCorrectIntentAction(intentAction: String?) =
            intentAction == ACTION_CONNECTION_STATE_CHANGED ||
                intentAction == ACTION_AUDIO_STATE_CHANGED ||
                intentAction == ACTION_SCO_AUDIO_STATE_UPDATED

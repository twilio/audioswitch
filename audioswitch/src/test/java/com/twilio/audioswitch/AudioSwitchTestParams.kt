...
class EarpieceAndSpeakerParams {
    companion object {
        @JvmStatic
        fun provideParams(): Array<Any> = getTestInput(EarpieceAndSpeakerTest)
    }
}
...
class WiredHeadsetParams {
    companion object {
        @JvmStatic
        fun provideParams(): Array<Any> = getTestInput(WiredHeadsetTest)
    }
}
...
class BluetoothHeadsetParams {
    companion object {
        @JvmStatic
        fun provideParams(): Array<Any> = getTestInput(BluetoothHeadsetTest)
    }
}
